...
// use pr::pr;
// mod debug_eusart;
// use crate::peripherals::debug_eusart::pr;

// mod lleo_dev;
// use kampela_ui::lleo_dev;
// use kampela_ui::lleo; // ::{pr};
...
*/
    ...
    loop {
        ...
        unsafe {
            LOOP_COUNTER += 1;
            if LOOP_COUNTER % 50000 == 0 { prn(format!(".")); }
        }
        ...
        // unsafe {
            // pr(format!("Tervetuloa Kampelaan!"));
            // write_debug_eusart(debug_data_char);
        // }

        // if debug_data_char == b'\n' {
        //     debug_data_char = b'a';
        // } else if debug_data_char >= b'z' {
        //         debug_data_char = b'\n';  
        // } else {
        //     debug_data_char += 1;
        // }
        
// panic!("debug_data_char: {:#?}",debug_data_char);
